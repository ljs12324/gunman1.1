...
def detction():
    ...
    while out:
        ...
        if float(resluttime[0]) < 0.01:
            xunhuancishu += 1
            print("yijinxunhuanl:", xunhuancishu)
        else:
            out = False
            print("zuizhongxunhuan", xunhuancishu)
...
def detction1():
    ...
    starttime = input("this is a you hava start time to input:")
    jiangeshijian = 2
    timelist = []
    # t1 = threading.Thread(target=job, args=(timelist,), name='job1')
    # t2 = threading.Thread(target=generate_flow, args=(net, topo, 0), name='job2')
    ...
    while out:
        ...
        if float(resluttime[0]) < 0.01:
            jiangeshijian += 1
            print("yijinxunhuanl:", jiangeshijian)
        else:
            out = False
            print("zuizhongxunhuan", jiangeshijian - 1)
